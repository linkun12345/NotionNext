...
const BLOG = {
  ...
  NOTION_PAGE_ID:   
    process.env.NOTION_PAGE_ID || '4d8105515db24fc39ba200e176af0776',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'XMUT', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '厦门理工学院互联网+', // 作者简介
